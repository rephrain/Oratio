...
import { d as db, c as doctorItems, u as users, s as shifts, p as patients, f as patientDiseaseHistory, g as patientAllergy, h as patientMedication, t as terminologyMaster, i as documents, e as encounters, j as statusHistory, k as encounterOdontograms, o as odontogramTeeth, l as odontogramSurfaces, m as odontogramRestorations, q as odontogramRestorationSurfaces, v as odontogramDiagnoses, w as odontogramProcedures, x as encounterPrescriptions, y as encounterReferrals, z as items, A as encounterItems, B as payments, C as doctorSuster } from './index3-af609ec3.js';
import { eq, inArray, sql, or, and, desc } from 'drizzle-orm';
import { A as ADMIN_TABLES } from './constants-29762e90.js';
...
async function POST({ params, request }) {
  ...
  if (params.table === "users") {
    if (body.password) {
      const { hashPasswordAsync } = await import('./auth-fb0aff02.js');
...
//# sourceMappingURL=_server-b39c2df8.js.map
