...
return {
	...
	_: {
		...
		nodes: [
			...
			__memo(() => import('./chunks/1-73364672.js')),
			__memo(() => import('./chunks/2-3d76ecbe.js')),
			__memo(() => import('./chunks/3-a8e06684.js')),
			__memo(() => import('./chunks/4-74e1f65b.js')),
			__memo(() => import('./chunks/5-98f12be5.js')),
			__memo(() => import('./chunks/6-1cff49a3.js')),
			__memo(() => import('./chunks/7-cfd97195.js')),
			__memo(() => import('./chunks/8-d1e46c1e.js')),
			__memo(() => import('./chunks/9-5b247c5c.js')),
			__memo(() => import('./chunks/10-2e52a213.js')),
			__memo(() => import('./chunks/11-5de9d510.js')),
			__memo(() => import('./chunks/12-b881e092.js')),
			__memo(() => import('./chunks/13-595e5da9.js')),
			__memo(() => import('./chunks/14-9d4883be.js')),
			__memo(() => import('./chunks/15-f930cc72.js')),
			__memo(() => import('./chunks/16-2a7052fb.js')),
			__memo(() => import('./chunks/17-1c7db3e4.js')),
			__memo(() => import('./chunks/18-cad1fd97.js')),
			__memo(() => import('./chunks/19-93764233.js')),
			__memo(() => import('./chunks/20-86fbe050.js')),
			__memo(() => import('./chunks/21-0d094e5b.js')),
			__memo(() => import('./chunks/22-23b3957d.js')),
			__memo(() => import('./chunks/23-bec813da.js')),
			__memo(() => import('./chunks/24-87f7b6b5.js'))
		],
		routes: [
			{
				id: "/admin",
			...
			},
			{
				...
				params: [{"name":"table","optional":false,"rest":false,"chained":false}],
				page: null,
				endpoint: __memo(() => import('./chunks/_server-de73e64e.js'))
			},
			{
				id: "/api/analytics",
