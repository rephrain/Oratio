# Graph Report - Oratio  (2026-09-13)

## Corpus Check
- 165 files · ~196,563 words
...
Cohesion: 0.04
Nodes (7): $lib/components/UI/Modal.svelte, $lib/components/Odontogram/OdontogramChart.svelte, calculateAge(), formatDate(), calculateAge(), formatDate(), $lib/components/Odontogram/ToothDetailPanel.svelte
