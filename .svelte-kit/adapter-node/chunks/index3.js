...
export {
  ...
  doctorItems as b,
  patientDiseaseHistory as c,
  db as d,
  encounters as e,
  patientAllergy as f,
  patientMedication as g,
  documents as h,
  statusHistory as i,
  encounterOdontograms as j,
  odontogramSurfaces as k,
  odontogramRestorations as l,
  odontogramRestorationSurfaces as m,
  notifications as n,
  odontogramTeeth as o,
  patients as p,
  odontogramDiagnoses as q,
  odontogramProcedures as r,
  shifts as s,
  terminologyMaster as t,
  users as u,
  encounterPrescriptions as v,
  encounterReferrals as w,
  items as x,
  encounterItems as y,
  payments as z
};
