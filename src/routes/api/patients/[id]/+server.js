...
export async function GET({ params }) {
	...
	try {
		...
		// Get disease history with codes
...
export async function PUT({ params, request, locals }) {
	...
	try {
		...
		// 3. Clear and insert disease history
		...
		// 5. Clear and insert medications
		...
		try {
			...
			// Find or Insert document record
