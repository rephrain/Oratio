import { c as create_ssr_component, o as onDestroy, f as escape, e as each, g as add_attribute } from './ssr-4a5a9ccc.js';
...
const Page = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `${$$result.head += `<!-- HEAD_svelte-3sbvp1_START -->${$$result.title = `<title>Dashboard Dokter — Oratio Clinic</title>`, ""}<!-- HEAD_svelte-3sbvp1_END -->`, ""} <div class="-m-6 flex h-[calc(100vh-73px)] bg-slate-50 overflow-hidden font-sans relative"><section class="${"flex-1 min-w-0 " + escape(
    "mr-0",
    true
  ) + " transition-all duration-300 ease-in-out overflow-y-auto overflow-x-hidden custom-scrollbar p-6"}"> <div class="flex items-center justify-end mb-6"><p class="text-xs font-bold text-slate-400 uppercase tracking-widest">${escape(( new Date(filterDate + "T00:00:00")).toLocaleDateString("id-ID", {
    weekday: "long",
    day: "numeric",
    month: "long",
    year: "numeric"
...
//# sourceMappingURL=_page.svelte-4db857ce.js.map
