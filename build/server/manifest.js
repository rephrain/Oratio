...
return {
	...
	_: {
		...
		nodes: [
			...
			__memo(() => import('./chunks/1-b1393bb5.js')),
			__memo(() => import('./chunks/2-02eb4980.js')),
			__memo(() => import('./chunks/3-9dcba897.js')),
			__memo(() => import('./chunks/4-28c00c21.js')),
			__memo(() => import('./chunks/5-e53b81b3.js')),
			__memo(() => import('./chunks/6-601ff20c.js')),
			__memo(() => import('./chunks/7-029201ec.js')),
			__memo(() => import('./chunks/8-d97b9044.js')),
			__memo(() => import('./chunks/9-498c34f5.js')),
			__memo(() => import('./chunks/10-89fd1643.js')),
			__memo(() => import('./chunks/11-37f119e6.js')),
			__memo(() => import('./chunks/12-3d7fc51c.js')),
			__memo(() => import('./chunks/13-edd52218.js')),
			__memo(() => import('./chunks/14-ee2c8266.js')),
			__memo(() => import('./chunks/15-3a09ec94.js')),
			__memo(() => import('./chunks/16-d58a7235.js')),
			__memo(() => import('./chunks/17-921bcc73.js')),
			__memo(() => import('./chunks/18-b36c710e.js')),
			__memo(() => import('./chunks/19-d5d736b0.js')),
			__memo(() => import('./chunks/20-e7dba5a7.js')),
			__memo(() => import('./chunks/21-01131e09.js')),
			__memo(() => import('./chunks/22-85e267b6.js')),
			__memo(() => import('./chunks/23-943287d8.js')),
			__memo(() => import('./chunks/24-b3a3d75b.js')),
			__memo(() => import('./chunks/25-6f08e4dc.js'))
		],
		routes: [
			{
				id: "/admin",
			...
			},
			{
				...
				params: [{"name":"table","optional":false,"rest":false,"chained":false}],
				page: null,
				endpoint: __memo(() => import('./chunks/_server-6cef7b93.js'))
			},
			{
				id: "/api/analytics",
