import { c as create_ssr_component, a as subscribe, e as escape, v as validate_component, f as add_attribute } from "./ssr.js";
import { S as Sidebar } from "./Sidebar.js";
import { a as isSidebarHidden, b as isSidebarOpen, h as headerTitle, c as isPatientProfileOpen, i as isProfileModalOpen } from "./layout.js";
import { c as chatView, a as isChatOpen, i as isNotificationOpen, u as unreadNotificationCount, b as unreadCount, P as ProfileModal, C as ChatPanel, N as NotificationPanel } from "./ChatPanel.js";
import { C as ConnectionStatus } from "./ConnectionStatus.js";
...
const AppShell = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  ].join(" ").trim()}">${validate_component(Sidebar, "Sidebar").$$render($$result, { role, user }, {}, {})} ${validate_component(Header, "Header").$$render($$result, { title, user }, {}, {})} <div class="main-content"><div class="page-content">${slots.default ? slots.default({}) : ``}</div></div></div> ${validate_component(ChatPanel, "ChatPanel").$$render($$result, { user }, {}, {})} ${validate_component(NotificationPanel, "NotificationPanel").$$render($$result, { user, isAdmin: role === "admin" }, {}, {})}`;
});
export {
  AppShell as A
};
