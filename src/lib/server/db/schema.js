import { pgTable, uuid, varchar, text, integer, boolean, timestamp, time, date, decimal, check, unique, pgEnum } from 'drizzle-orm/pg-core';
...
export const encounterStatusEnum = pgEnum('encounter_status', ['Planned', 'Arrived', 'In Progress', 'On Hold', 'Discharged', 'Completed', 'Cancelled', 'Discontinued']);
export const formModeEnum = pgEnum('form_mode', ['SOAP', 'SOAP-WHO']);
...
export const patients = pgTable('patients', {
	id: varchar('id', { length: 20 }).primaryKey(), // O000001 format
...
export const encounters = pgTable('encounters', {
	id: varchar('id', { length: 30 }).primaryKey(), // YYYYMM{DoctorCode}NNNNNN
