...
{#if role === "kasir"}
	<aside
		class="w-64 bg-forest flex flex-col h-full text-white shrink-0 shadow-lg z-20 font-display"
	>
		<div class="p-6 flex items-center gap-3">
			<div
				class="size-10 bg-primary rounded-lg flex items-center justify-center"
			>
		...
		<nav class="flex-1 px-4 space-y-2 mt-4">
			<a
				class="flex items-center gap-3 px-4 py-3 {currentPath ===
				'/kasir'
