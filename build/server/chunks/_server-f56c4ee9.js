...
import { d as db, u as users, s as shifts, p as patients, c as patientDiseaseHistory, f as patientAllergy, g as patientMedication, t as terminologyMaster, h as documents, e as encounters, i as statusHistory, j as encounterOdontograms, o as odontogramTeeth, k as odontogramSurfaces, l as odontogramRestorations, m as odontogramRestorationSurfaces, q as odontogramDiagnoses, v as odontogramProcedures, w as encounterPrescriptions, x as encounterReferrals, y as items, z as encounterItems, A as payments } from './index3-5403fb4f.js';
import { inArray, eq, sql, or, and, desc } from 'drizzle-orm';
import { A as ADMIN_TABLES } from './constants-5167fb30.js';
import { g as generatePatientId } from './formatters-e16410d8.js';
import 'postgres';
...
async function POST({ params, request }) {
  ...
  if (params.table === "users") {
    if (body.password) {
      const { hashPasswordAsync } = await import('./auth-adecefa5.js');
...
//# sourceMappingURL=_server-f56c4ee9.js.map
