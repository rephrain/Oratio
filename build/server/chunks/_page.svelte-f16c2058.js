import { c as create_ssr_component, a as subscribe, o as onDestroy, f as escape, v as validate_component, e as each, g as add_attribute, d as createEventDispatcher, j as compute_slots } from './ssr-a9ffd974.js';
import { p as page } from './stores-9f4626d1.js';
import { A as ADMIN_TABLES } from './constants-4593e640.js';
import { a as addToast } from './toast-26f016f8.js';
import './index2-02454b86.js';
...
const Page = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  do {
    ...
    $$rendered = `${$$result.head += `<!-- HEAD_svelte-s1eqld_START -->${$$result.title = `<title>${escape(tableConfig?.label || tableName)} — Admin — Oratio Clinic</title>`, ""}<!-- HEAD_svelte-s1eqld_END -->`, ""} <div class="p-8 space-y-8 overflow-y-auto custom-scrollbar"><div class="flex items-end justify-between"><div><h1 class="text-3xl font-black text-slate-900 dark:text-white tracking-tight mb-2">${escape(tableConfig?.label || tableName)}</h1> <p class="text-slate-500 font-medium">${escape(total)} total records in database</p></div> <div class="flex gap-3"><a href="/admin" class="px-4 py-2 border border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-900 text-slate-600 dark:text-slate-400 hover:text-slate-900 dark:hover:text-white rounded-lg text-sm font-bold flex items-center gap-2 hover:bg-slate-50 dark:hover:bg-slate-800 transition-colors" data-svelte-h="svelte-144j7mv"><span class="material-symbols-outlined text-[18px]">arrow_back</span>
				Dashboard</a> <button class="px-4 py-2 bg-primary text-white rounded-lg text-sm font-bold flex items-center gap-2 shadow-lg shadow-primary/30 hover:shadow-primary/40 hover:-translate-y-0.5 transition-all" data-svelte-h="svelte-1i8fbpi"><span class="material-symbols-outlined text-[18px]">add</span>
      ...
      {
        footer: () => {
          return `<div slot="footer"><button class="px-4 py-2 border border-slate-200 bg-white text-slate-600 hover:bg-slate-50 hover:text-slate-900 rounded-lg font-bold text-sm transition-colors" data-svelte-h="svelte-f8hqnc">Batal</button> <button class="px-4 py-2 bg-red-600 text-white rounded-lg font-bold text-sm shadow-lg shadow-red-600/30 hover:shadow-red-600/40 hover:-translate-y-0.5 transition-all flex items-center gap-2" data-svelte-h="svelte-197oo5a"><span class="material-symbols-outlined text-[18px]">delete</span>
			Ya, Hapus</button></div>`;
        },
        default: () => {
          return `<div class="flex items-start gap-4" data-svelte-h="svelte-3sksza"><div class="size-12 rounded-full bg-red-100 flex items-center justify-center shrink-0"><span class="material-symbols-outlined text-red-600">warning</span></div> <div><h4 class="text-lg font-bold text-slate-900 mb-1">Hapus Data?</h4> <p class="text-slate-500 text-sm">Apakah Anda yakin ingin menghapus data ini? Tindakan ini tidak dapat
...
//# sourceMappingURL=_page.svelte-f16c2058.js.map
