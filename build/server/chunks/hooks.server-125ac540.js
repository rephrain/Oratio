import { d as db, e as encounters } from './index3-41fb71fd.js';
...
async function handle({ event, resolve }) {
  ...
  const { db: db2 } = await import('./index3-41fb71fd.js').then((n) => n.C);
  const { users } = await import('./index3-41fb71fd.js').then((n) => n.B);
...
export { handle };
//# sourceMappingURL=hooks.server-125ac540.js.map
